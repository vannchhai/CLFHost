...
<html >
  <head>
    ...
    <link rel="stylesheet" href="{{ url('app/css/customize.css') }}">  
  </head>
  <body>
    ...
    <div>
       <style id="dynamic-styles"></style>
        ...
        <!-- Header -->
        <div  data-bind="if: app.views() == 'List' || app.views() == 'Map' || app.views() == 'Notification' || app.views() == 'Profile' || app.views() == 'Menu'">
        ...
        <div id="content">
          <div id="container">
            ...
            <!-- login section -->
              ...
              <div id="" data-bind="animate:{ animationOn: app.animateIn, animationOff: app.animateOut, state: app.views() == 'Login'}">
                  <div id="form">
                  <div class="logo">
                  ...
                  <g>
                    ...
                    <path d="M70.9,26.4c8.6-1,104.7-7.5,113-7.5c4.7,0,13-18.9,3.3-18.9C184.8,0,90,6.7,80.4,7.6
                      ...
                      <div class="form-item">
                        ...
                        <input type="email" name="email" id="email" class="form-style" autocomplete="off" data-bind="value: email"/>
                      </div>
                      <div class="form-item">
                        <p class="formLabel">Password</p>
                        <input type="password" name="password" id="password" class="form-style" data-bind="value: password"/>

                        <input type="submit" class="login" value="Log In" data-bind="click: app.processLogin">
                      </div>
                      <div class="form-item">
          ...
          <div data-bind="animate:{ animationOn: app.animateIn, animationOff: app.animateOut, state: app.views() == 'List'}">
            <div class="meta-bar"><input class="nostyle search-filter" type="text" placeholder="Search" /></div>
            <ul class="">      
              <li class="list-post">
                <div>
                  <div class="p_img">
                  <img src="{{ url('app/img/index.png') }}" class="img-profile">
                  </div>
                  <div class="p_name">
                    <strong>Chhai</strong><br>
                    <small>2h</small>
                  </div>
                </div>

                <div>
                 <img src="{{ url('app/img/logo.png') }}" class="img-post">
                </div>
                ...
                <ul class="footer-post">
                  ...
                  <li class="comment"> 
                    <a href="#"><i class="mdi mdi-facebook-messenger"></i></a>
                  </li>
                </ul>
              </li>
            </ul> 
          ...
          <div data-bind="animate:{ animationOn: app.animateIn, animationOff: app.animateOut, state: app.views() == 'Map'}">
            <ul class="">      
              <li class="list-post">
               Map
              </li>
          ...
          <div data-bind="animate:{ animationOn: app.animateIn, animationOff: app.animateOut, state: app.views() == 'Profile'}">
          ...
          <div data-bind="animate:{ animationOn: app.animateIn, animationOff: app.animateOut, state: app.views() == 'Notification'}">
            <div class="meta-bar"></div>
              <ul class="list mat-ripple">      
              <li><img src="{{ url('app/img/index.png') }}"><span class="name">Angie</span><i class="mdi mdi-menu-down"></i> </li>
              <li><img src="{{ url('app/img/index.png') }}"><span class="name">Larissa</span><i class="mdi mdi-menu-down"></i></li>
              <li><img src="{{ url('app/img/index.png') }}"><span class="name">Hank</span><i class="mdi mdi-menu-down"></i></li>    
              <li><img src="{{ url('app/img/index.png') }}"><span class="name">Peter</span><i class="mdi mdi-menu-down"></i></li> 
              <li><img src="{{ url('app/img/index.png') }}"><span class="name">Oliver</span><i class="mdi mdi-menu-down"></i></li> 
              <li><img src="{{ url('app/img/index.png') }}"><span class="name">Chris</span><i class="mdi mdi-menu-down"></i></li> 
              <li><img src="{{ url('app/img/index.png') }}"><span class="name">Vanessa</span><i class="mdi mdi-menu-down"></i></li> 
              <li><img src="{{ url('app/img/index.png') }}"><span class="name">Leo</span><i class="mdi mdi-menu-down"></i></li> 
              <li><img src="{{ url('app/img/index.png') }}"><span class="name">Ash</span><i class="mdi mdi-menu-down"></i></li> 
              <li><img src="{{ url('app/img/index.png') }}"><span class="name">Doozer</span><i class="mdi mdi-menu-down"></i></li> 
              <li><img src="{{ url('app/img/index.png') }}"><span class="name">Munk</span><i class="mdi mdi-menu-down"></i></li> 
            </ul> 
          </div>


          <div data-bind="animate:{ animationOn: app.animateIn, animationOff: app.animateOut, state: app.views() == 'Menu'}">
            <div class="meta-bar"></div>
            <ul class="list mat-ripple">      
              <li><img src="{{ url('app/img/comment-multiple-outline.png') }}"><span class="name">Messenger</span><i class="mdi mdi-menu-down"></i> </li>
              <li><img src="{{ url('app/img/account-switch.png') }}"><span class="name">Contact Us</span><i class="mdi mdi-menu-down"></i></li>
              <li><img src="{{ url('app/img/alert-circle-outline.png') }}"><span class="name">About Us</span><i class="mdi mdi-menu-down"></i></li>    
              <li data-bind="click: app.cl_logout"><img src="{{ url('app/img/lock-outline.png') }}"><span class="name">Logout</span></li> 
            </ul> 
          </div>
          </div>
          ...
          <div  data-bind="if: app.views() == 'List' || app.views() == 'Map' || app.views() == 'Notification' || app.views() == 'Profile' || app.views() == 'Menu'">
              <ul class="nav control mat-ripple tiny">
                <li data-bind="click: app.cl_home"><i class="mdi mdi-home"></i></li><li data-bind="click: app.cl_map"><i class="mdi mdi-map"></i></li><li data-bind="click: app.cl_profile"><i class="mdi mdi-account-circle"></i></li><li data-bind="click: app.cl_notification"><i class="mdi mdi-bell-outline"></i></li><li data-bind="click: app.cl_menu"><i class="mdi mdi-format-list-bulleted"></i></li></ul>
              </div> 
          </div>
  ...
  <div id="contact-modal" data-mode="add" class="card dialog">
    ...
    <script src='{{ url("app/library/jquery-3.1.0.js") }}'></script>
    <script type="text/javascript" src="{{ url('app/library/knockout-3.4.0.custom.js') }}"></script>
    <script type="text/javascript" src="{{ url('app/library/knockout.validation.js') }}"></script>
    <script type="text/javascript" src="{{ url('app/library/knockout.animate.js') }}"></script>
    <script type="text/javascript" src="{{ url('app/library/knockout.extension.js') }}"></script>
    <script type="text/javascript" src="{{ url('app/library/moment.js') }}"></script>
    <script type="text/javascript" src="{{ url('app/app/common.js') }}"></script>
    <script type="text/javascript" src="{{ url('app/app/app.datamodel.js') }}"></script>
    <script type="text/javascript" src="{{ url('app/app/app.viewmodel.js') }}"></script>
    <script type="text/javascript" src="{{ url('app/app/_run.js') }}"></script>
    <script src="{{ url('app/js/index.js') }}"></script>   
