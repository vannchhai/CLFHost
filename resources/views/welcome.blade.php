                        ...
                        <div class="review-filtering">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="review-person">
                                            <img src="{{ url('public/assets/img/freeze/user/mesa.jpg')}}" alt="" class="img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="review-comment">
                                            <h3>“I love This App, I highly rfreezemmend it, Everyone Try It Now”</h3>
                                            <p>
                                                - Mesa
                                                <span>
                            ...
                            <div class="review rollitin">
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="review-person">
                                            <img src="{{ url('public/assets/img/freeze/user/viphea.jpg')}}" alt="" class="img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="review-comment">
                            ...
                            <div class="review rollitin">
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="review-person">
                                            <img src="{{ url('public/assets/img/freeze/user/voleak.jpg')}}" alt="" class="img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="review-comment">
                            ...
                            <div class="review rollitin">
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="review-person">
                                            <img src="{{ url('public/assets/img/freeze/user/chenda.jpg')}}" alt="" class="img-responsive">
                                        </div>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="review-comment">
                                            <h3>“Nice Projection Application”</h3>
                                            <p>
                                                - Chenda
                                                <span>
                                                    <i class="fa fa-star fa-lg"></i>
